# Autogenerated wrapper script for asdf_cxx_jll for armv6l-linux-musleabihf-cxx11
...
JLLWrappers.@declare_library_product(libasdf_cxx, "libasdf-cxx.so.8")
